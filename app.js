// IndexedDB name config.js → window.APP_IDENTITY.idb_name থেকে নেওয়া হচ্ছে
const DB_NAME=(window.APP_IDENTITY&&window.APP_IDENTITY.idb_name)||"csm-db-v2",STORE="imgs";
