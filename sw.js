// CSM DRIVE V2 — Service Worker
// Developer: Csm Mohasin Alam
const CACHE = 'csm-drive-v2-cache-v1'; // v1 এর 'csm-drive-v4' থেকে আলাদা → conflict নেই
const STATIC = [
...
self.addEventListener('sync', e => {
    if (e.tag === 'csm-v2-sync-queue')   e.waitUntil(broadcast('PROCESS_SYNC_QUEUE'));
    if (e.tag === 'csm-v2-upload-queue') e.waitUntil(broadcast('PROCESS_UPLOAD_QUEUE'));
});
